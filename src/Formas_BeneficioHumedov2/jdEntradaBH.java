 ...
 * @author USUARIO
 */
public class jdEntradaBH extends javax.swing.JDialog {

    /**
     * Creates new form jdBoletaEntradaBH
     */
    String idBoleta, idSociedad, idBeneficio, tipoOrigen, ventanaOrigen;
    Connection cn;
    ...
    public jdEntradaBH(java.awt.Frame parent, boolean modal, String idBoleta, String idSociedad, String idBeneficio, String tipoOrigen, String ventanaOrigen, Connection cn) throws ParseException {
        super(parent, modal);
        initComponents();
 ...
 /*Dato0 :RE-GT-4
            ...
            if (valor == true) {
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    ...
                    if (mbh.insertarEnCiclo("insert into boletaentradabh values"
                        ...
                        mbh.actualizarBoleta("update boletasalidareceptor set estatus='0' where idBoleta='" + idBoleta + "'");
                    }
                }
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdEntradaBH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
