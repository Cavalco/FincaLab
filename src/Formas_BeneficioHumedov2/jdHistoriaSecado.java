 ...
 * @author Cronos
 */
public class jdHistoriaSecado extends javax.swing.JDialog {

    /**
     * Creates new form jdHistoriaSecado
     */
    public jdHistoriaSecado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Nuevo Registro", jPanel2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdHistoriaSecado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdHistoriaSecado dialog = new jdHistoriaSecado(new javax.swing.JFrame(), true);
