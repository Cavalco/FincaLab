...
public class jpBeneficiosH extends javax.swing.JPanel {
    ...
    jdBeneficioH jdBH;
    String estado = "=1", Idioma;
    Propiedades idioma;

    public jpBeneficiosH(Connection cn, String Idioma) {
        initComponents();
    ...
    public void traductor() {
        jLabel1.setText(idioma.getProperty("Beneficio"));
        ...
        jTable1.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("BeneficioHumedo"));
        ...
        jTable1.getColumnModel().getColumn(5).setHeaderValue(idioma.getProperty("Telefono"));
        ...
        jTable1.getColumnModel().getColumn(9).setHeaderValue(idioma.getProperty("Sociedad"));
    ...
    public void llenarTabla() {
        ...
        if (jTextField1.getText().length() > 0) {
            where += " AND bh.nombre like '" + jTextField1.getText() + "%'";
        }
        if (jTextField2.getText().length() > 0) {
            where += " AND pf.nombre like '" + jTextField2.getText() + "%'";
        }
        if (jTextField3.getText().length() > 0) {
            where += " AND bh.domicilio like '" + jTextField3.getText() + "%'";
        }
        if (jTextField4.getText().length() > 0) {
            where += " AND pm.nombrecorto like '" + jTextField4.getText() + "%'";
        }

        mdb.cargarInformacion2(modelo, 10, "select bh.nombre, bh.nombrecorto, CONCAT(pf.Nombre, ' ', pf.apellidoPaterno, ' ', pf.apellidoMaterno),CONCAT(pf2.Nombre, ' ', pf2.apellidoPaterno, ' ', pf2.apellidoMaterno), bh.domicilio, bh.telefono, e.Descripcion,m.Descripcion,l.Descripcion,pm.NombreCorto\n"
                ...
                + "left join personam pm on (bh.idSociedad=pm.ID) where idEstado" + estado + where
        );
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Beneficio Humedo", "Nombre Corto", "Responsable", "Capturista", "Domicilio", "Telefono", "Estado", "Municipio", "Localidad", "Sociedad"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        jdBH = new jdBeneficioH(null, true, "", "Nuevo", Idioma, cn);
        jdBH.jpBH = this;
