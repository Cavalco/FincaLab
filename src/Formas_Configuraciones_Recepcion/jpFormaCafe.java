...
public class jpFormaCafe extends javax.swing.JPanel {
    ...
    public jpFormaCafe(Connection c, String Idioma) {
        initComponents();
        ...
        //jLabel7.setText(idioma.getProperty("FormaDeCafe"));
      
        tablaFormaCafe.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("Clave"));
        //tablaFormaCafe.getColumnModel().getColumn(1).setHeaderValue(idioma.getProperty("FormaDeCafe"));
        ...
        PromptSupport.setPrompt(idioma.getProperty("FormaDeCafe"), txtBusquedaForma);
    ...
    public void busqueda() {
        ...
        if (situacion.equals("3")) {
            sql = "select f.clave, f.descripcion "
                    + "from formacafe f "
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdFC = new jdFormaCafe(null, true, "1", clave, desc, Idioma, cn);
        jdFC.jpFC = this;
           ...
           // situacion = tablaFormaCafe.getValueAt(tablaFormaCafe.getSelectedRow(), 2) + "";
            ...
            if (evt.getClickCount() == 2) {
             //   if (situacion.equals("Activo")) {
                    jdFC = new jdFormaCafe(null, true, "2", clave, desc, Idioma, cn);
                    jdFC.jpFC = this;
                    jdFC.setVisible(true);
            //    } else {
  ...
  /*      if (comboSituacion.getSelectedItem().equals("Inactivo")) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (clave.equals("")){
            ...
            sql = "UPDATE formacafe SET ID_Situacion=2 where clave = '" + clave + "'";
        } else if (comboSituacion.getSelectedIndex() == 1) {
            sql = "UPDATE formacafe SET ID_Situacion=1 where clave = '" + clave + "'";
        }
