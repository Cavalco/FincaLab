 ...
 */
public class jpProcesoCafe extends javax.swing.JPanel {
    ...
    public jpProcesoCafe(Connection c, String Idioma) {
        initComponents();
        cn = c;
        this.Idioma = Idioma;
        ...
        PromptSupport.setPrompt(idioma.getProperty("ProcesoDeCafe"), txtBusquedaK);
    ...
    public void etiquetas(){
        ...
        jLabel7.setText(idioma.getProperty("ProcesoDeCafe"));

        tabla.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("Clave"));
        tabla.getColumnModel().getColumn(1).setHeaderValue(idioma.getProperty("ProcesoDeCafe"));
    }

    public void llenaTabla() {
        limpiar(tabla);
        mdb = new metodosDatosBasicos(cn, Idioma);
        mdb.cargarInformacion2(modelo, 2, "select clave,Descripcion from procesocafe where ID_Situacion=1");
    }
    ...
    public void busqueda() {
        ...
        if (situacion.equals("3")) {
            sql = "SELECT Clave,Descripcion from ProcesoCafe WHERE ID_Situacion <> 3 " + tipoP + " " + tipoK;
        } else {
            sql = "SELECT Clave,Descripcion from ProcesoCafe WHERE ID_Situacion = " + situacion + " " + tipoP + " " + tipoK;
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdR = new jdProcesoCafe(null, true, "1", Clave, TxTvar, Idioma, cn);
        jdR.jp = this;
        jdR.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Clave.equals("")) {
            ...
            jdR = new jdProcesoCafe(null, true, "2", Clave, TxTvar, Idioma, cn);
            jdR.jp = this;
            jdR.setVisible(true);
            Clave = "";
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (Clave.equals("")) {
            ...
            if (comboSituacion.getSelectedIndex() == 0) {
                sql = "UPDATE procescafe SET ID_Situacion=2 where descripcion='" + Clave + "'";
            } else if (comboSituacion.getSelectedIndex() == 1) {
                sql = "UPDATE procesocafe SET ID_Situacion=1 where descripcion='" + Clave + "'";
            }
