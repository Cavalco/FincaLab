 ...
 */
public class jpMaximoTamañoPromedio extends javax.swing.JPanel {

    /**
     * Creates new form jp
     */
    pantallaPrincipal fprin;
    jdMaximoTamañoPromedio jdR;
    metodosDatosBasicos mdb;
    DefaultTableModel modelo;
    Connection cn;

    public jpMaximoTamañoPromedio(Connection c) {
        initComponents();
        cn = c;
    ...
    public void llenaTabla() {
        limpiar(tabla);
        mdb.cargarInformacion2(modelo,2,"select MaximoTamaño,Tipo from MaximoTamañoPromedio where ID_Situacion=1");
    }
    ...
    public void busqueda() {
        ...
        if (txtBusquedaP.getText().length() > 0) {
            tipoP = " AND MaximoTamaño like '%" + txtBusquedaP.getText() + "%'";
        }
       ...
       /* if (txtBusquedaUE.getText().length() > 0) {
        ...
        if (situacion.equals("Todos")) {
            sql = "SELECT MaximoTamaño,Tipo from MaximoTamañoPromedio WHERE ID_Situacion<>3 "+tipoP+tipoK;
        } else {
            sql = "SELECT MaximoTamaño,Tipo  from MaximoTamañoPromedio WHERE ID_Situacion=" + situacion+tipoP+tipoK;
        }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Maximo Tamaño Promedio:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdR = new jdMaximoTamañoPromedio(null, true, "1", MaximoTamaño, TxTvar, cn);
        jdR.jp = this;
        jdR.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        if (MaximoTamaño.equals("")) {
            JOptionPane.showMessageDialog(null,"selecciona un registro");
        }else{
             jdR = new jdMaximoTamañoPromedio(null, true, "2",MaximoTamaño, TxTvar ,cn);
        jdR.jp = this;
        jdR.setVisible(true);
        }
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        MaximoTamaño = modelo.getValueAt(tabla.getSelectedRow(), 0) + "";  //
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String sql = "UPDATE MaximoTamañoPromedio SET ID_Situacion=2 where MaximoTamaño='" + MaximoTamaño+ "'";
