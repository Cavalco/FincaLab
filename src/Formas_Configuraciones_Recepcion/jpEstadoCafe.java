 ...
 */
public class jpEstadoCafe extends javax.swing.JPanel {
    ...
    public jpEstadoCafe(Connection c, String Idioma) {
        initComponents();
        cn = c;
        this.Idioma=Idioma;
        ...
        //jLabel7.setText(idioma.getProperty("EstadoDeCafe"));

        tabla.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("Clave"));
        tabla.getColumnModel().getColumn(1).setHeaderValue(idioma.getProperty("EstadoDeCafe"));
        ...
        PromptSupport.setPrompt(idioma.getProperty("EstadoDeCafe"), txtBusquedaK);
    ...
    public void llenaTabla() {
        limpiar(tabla);
        mdb.cargarInformacion2(modelo, 2, "select Clave,Descripcion from EstadoCafe where ID_Situacion=1");
    }
    ...
    public void busqueda() {
        ...
        if (situacion.equals("3")) {
            sql = "SELECT Clave,Descripcion from EstadoCafe WHERE ID_Situacion <> 3 " + tipoP + tipoK;
        } else {
            sql = "SELECT Clave,Descripcion  from EstadoCafe WHERE ID_Situacion = " + situacion + tipoP + tipoK;
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdR = new jdEstadoCafe(null, true, "1", Clave, TxTvar, Idioma, cn);
        jdR.jp = this;
        jdR.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Clave.equals("")) {
            ...
            jdR = new jdEstadoCafe(null, true, "2", Clave, TxTvar, Idioma, cn);
            jdR.jp = this;
            jdR.setVisible(true);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (Clave.equals("")){
            ...
            sql = "UPDATE EstadoCafe SET ID_Situacion=2 where clave = '" + Clave + "'";
        } else if (comboSituacion.getSelectedIndex() == 1) {
            sql = "UPDATE EstadoCafe SET ID_Situacion=1 where clave = '" + Clave + "'";
        }
