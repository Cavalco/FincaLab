 ...
 */
public class jdFormaEvaluacion extends javax.swing.JDialog {
    ...
    public jdFormaEvaluacion(java.awt.Frame parent, boolean modal, String tipo, String valor, String Idioma, Connection c) {
        super(parent, modal);
        initComponents();
        ...
        jTable1.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("TipoEvaluacion"));
        jTable1.getColumnModel().getColumn(1).setHeaderValue(idioma.getProperty("Valor"));



        llenarTabla();
        llenarCombo();
        setTitle("Nueva Forma - Evaluacion");
    ...
    public void llenarTabla() {
        ...
        mdb.cargarInformacion2(modelo, 1, "select descripcion from tipoevaluacion");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdFormaEvaluacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
