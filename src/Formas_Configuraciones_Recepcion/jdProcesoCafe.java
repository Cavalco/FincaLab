 ...
 */
public class jdProcesoCafe extends javax.swing.JDialog {
    ...
    public jdProcesoCafe(java.awt.Frame parent, boolean modal, String tipo, String ClaveC, String TxTvarC, String Idioma, Connection c) {
        super(parent, modal);
        initComponents();
        ...
        jLabel2.setText(idioma.getProperty("ProcesoDeCafe"));

        if (tipo.equals("1")) {
            setTitle(idioma.getProperty("NuevoProcesoDeCafe"));
        } else {
            setTitle(idioma.getProperty("EditarProcesoDeCafe"));
