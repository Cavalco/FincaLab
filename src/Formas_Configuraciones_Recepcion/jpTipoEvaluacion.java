 ...
 */
public class jpTipoEvaluacion extends javax.swing.JPanel {

    /**
     * Creates new form jpTEstado
     */
    jdTiposEvaluacion jdTE;
    Connection cn;
    ...
    public jpTipoEvaluacion(Connection c, String Idioma) {
        initComponents();
        ...
        //jLabel6.setText(idioma.getProperty("TiposDeEvaluacion"));
        //jLabel7.setText(idioma.getProperty("Formula"));

        tablaTipoEvaluacion.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("TiposDeEvaluacion"));
        tablaTipoEvaluacion.getColumnModel().getColumn(1).setHeaderValue(idioma.getProperty("Formula"));
        //tablaTipoEvaluacion.getColumnModel().getColumn(2).setHeaderValue(idioma.getProperty("Situacion"));
        ...
        PromptSupport.setPrompt(idioma.getProperty("TiposDeEvaluacion"), txtBusquedaTipo);
        PromptSupport.setPrompt(idioma.getProperty("Formula"), txtBusquedaFormula);
    ...
    public void busqueda() {
        ...
        if (situacion.equals("3")) {
            sql = "select t.descripcion, t.formula "
    ...
    private void initComponents() {
        ...
        tablaTipoEvaluacion = new javax.swing.JTable();
        ...
        tablaTipoEvaluacion.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaTipoEvaluacion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaTipoEvaluacionMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tablaTipoEvaluacion);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdTE = new jdTiposEvaluacion(null, true, "1", tipoevaluacion, formula, Idioma, cn);
        jdTE.jpTE = this;
    ...
    private void tablaTipoEvaluacionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaTipoEvaluacionMouseClicked
     ...
     //   situacion = tablaTipoEvaluacion.getValueAt(tablaTipoEvaluacion.getSelectedRow(), 2) + "";
        ...
        //    if (situacion.equals("Activo")) {
                jdTE = new jdTiposEvaluacion(null, true, "2", tipoevaluacion, formula, Idioma, cn);
                jdTE.jpTE = this;
                jdTE.setVisible(true);
        //    } else {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        //    if (situacion.equals("Activo")) {
                ...
                jdTE.setVisible(true);
        //    } else {
        //        JOptionPane.showMessageDialog(null, idioma.getProperty("DatoInactivo"));
        //    }
        }
...
/*        if (comboSituacion.getSelectedItem().equals("Inactivo")) {
    ...
    private javax.swing.JTable tablaTipoEvaluacion;
    private javax.swing.JTextField txtBusquedaFormula;
