...
public class jpRetenciones extends javax.swing.JPanel {
    ...
    public jpRetenciones(Connection c, String Idioma) {
        ...
        PromptSupport.setPrompt(idioma.getProperty("NombreDeLaRetencion"), txtBusquedaP);
        PromptSupport.setPrompt(idioma.getProperty("MontoRetencion"), txtBusquedaK);
    ...
    public void busqueda() {
        ...
        if (situacion.equals("3")) {
            sql = "select t.descripcion,t.Importe "
                    + "from retenciones t "
                    + " WHERE t.ID_Situacion <> 3 " + tipoP + tipoK;
        } else {
            sql = "select t.descripcion,t.Importe "
                    + "from retenciones t "
                    + "WHERE t.ID_Situacion = " + situacion + tipoP + tipoK;
        }
