 ...
 */
public class jpClima extends javax.swing.JPanel {
    ...
    public void llenaTabla() {
        ...
        mdb.cargarInformacion2(modelo,2,"select Clave,clima from Clima where ID_Situacion=1");
    }
    ...
    public void busqueda() {
       ...
       /* if (txtBusquedaUE.getText().length() > 0) {
        ...
        if (situacion.equals("Todos")) {
            sql = "SELECT Clave,clima from Clima WHERE ID_Situacion<>3 "+tipoP+tipoK;
        } else {
            sql = "SELECT Clave,clima  from Clima WHERE ID_Situacion=" + situacion+tipoP+tipoK;
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdR = new jdClima(null, true, "1", Clave, TxTvar, cn);
        jdR.jp = this;
        jdR.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Clave.equals("")) {
            JOptionPane.showMessageDialog(null,"selecciona un registro");
             ...
             jdR = new jdClima(null, true, "2",Clave, TxTvar ,cn);
        jdR.jp = this;
        jdR.setVisible(true);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String sql = "UPDATE Clima SET ID_Situacion=2 where Clave='" + Clave+ "'";
