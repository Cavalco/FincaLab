 ...
 */
public class jpAreaAlmacen extends javax.swing.JPanel {
    ...
    public jpAreaAlmacen(Connection c) {
        initComponents();
        cn = c;
    ...
    public void llenaTabla() {
        ...
        mdb.cargarInformacion2(modelo,3,"select Almacen,Clave,Area from AreaAlmacen where ID_Situacion=1");
    }
    ...
    public void busqueda() {
        ...
        if (txtBusquedaP.getText().length() > 0) {
            tipoP = " AND Almacen like '%" + txtBusquedaP.getText() + "%'";
        }
        if (txtBusquedaK.getText().length() > 0) {
            tipoK = " AND Clave like '%" + txtBusquedaK.getText() + "%'";
        }
       if (txtBusquedaL.getText().length() > 0) {
            tipoL = "AND Area like '%" + txtBusquedaL.getText() + "%'";
        }
      /*  if (txtBusquedaISO.getText().length() > 0) {
        ...
        if (situacion.equals("Todos")) {
            sql = "SELECT Almacen,Clave,Area from AreaAlmacen WHERE ID_Situacion<>3 "+tipoP+tipoK+tipoL;
        } else {
            sql = "SELECT Almacen,Clave,Area  from AreaAlmacen WHERE ID_Situacion=" + situacion+tipoP+tipoK+tipoL;
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdR = new jdAreaAlmacen(null, true, "1",Almacen, Clave, TxTvar, cn);
        jdR.jp = this;
        jdR.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Clave.equals("")) {
            JOptionPane.showMessageDialog(null,"selecciona un registro");
             ...
             jdR = new jdAreaAlmacen(null, true, "2",Almacen,Clave, TxTvar ,cn);
        jdR.jp = this;
        jdR.setVisible(true);
        }
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        Almacen = modelo.getValueAt(tabla.getSelectedRow(), 0) + "";
        Clave = modelo.getValueAt(tabla.getSelectedRow(), 1) + "";  //
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String sql = "UPDATE AreaAlmacen SET ID_Situacion=2 where Clave='" + Clave+ "'";
