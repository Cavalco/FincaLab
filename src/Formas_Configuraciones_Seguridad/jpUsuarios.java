...
public class jpUsuarios extends javax.swing.JPanel {
    ...
    public jpUsuarios(Connection c, String Idioma) {
        initComponents();
        cn = c;
        this.Idioma = Idioma;
        ...
        jLabel6.setText(idioma.getProperty("Usuario"));

        tablaUsuarios.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("Usuario"));
        tablaUsuarios.getColumnModel().getColumn(1).setHeaderValue(idioma.getProperty("Nombre"));
//        tablausuarios.getColumnModel().getColumn(2).setHeaderValue(idioma.getProperty("Situacion"));
        ...
        //PlaceHolder holder = new PlaceHolder(txtBusquedaP, idioma.getProperty("Usuario"));
        PromptSupport.setPrompt(idioma.getProperty("Usuario"), txtBusquedaP);
    ...
    public void busquedaUsuarios() {
        ...
        String valores = txtBusquedaP.getText();

        //Para que no agarre el placeholder
        /*if(txtBusquedaP.getText().equals(idioma.getProperty("Usuario"))){
            JOptionPane.showMessageDialog(this,"a ver que pedo");
            valores = "";
        }*/
        ...
        if (txtBusquedaP.getText().length() > 0) {
            tipoP = " AND u.usuario like '" + txtBusquedaP.getText() + "%'";
        }
   
        String sql;
        //System.out.println("SITUACION: " + situacion);
        if (situacion.equals("3")) {
            sql = "select usuario, CONCAT(pf.Nombre, ', ', pf.apellidoPaterno, ', ', pf.apellidoMaterno), u.id_situacion "
                    + "from usuarios u "
                    + "inner join personaf pf on (u.idPersona=pf.id) " + tipoP; // WHERE u.ID_Situacion<>3 " + tipoP;
        } else {
            sql = "select usuario, CONCAT(pf.Nombre, ', ', pf.apellidoPaterno, ', ', pf.apellidoMaterno), u.id_situacion "
                    + "from usuarios u "
                    + "inner join personaf pf on (u.idPersona=pf.id) WHERE u.ID_Situacion= " + situacion + tipoP;
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            jdU = new jdUsuarios(null, true, "Nuevo", usuarios, "","", Idioma, cn);
        } catch (ParseException ex) {
            Logger.getLogger(jpUsuarios.class.getName()).log(Level.SEVERE, null, ex);
        }
        jdU.jp = this;
        jdU.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (usuarios.equals("")) {
            ...
            try {
                jdU = new jdUsuarios(null, true, "Editar", usuarios, nombre,idPersona, Idioma, cn);
            } catch (ParseException ex) {
                Logger.getLogger(jpUsuarios.class.getName()).log(Level.SEVERE, null, ex);
            }
            jdU.jp = this;
    ...
    String usuarios = "", nombre = "", idPersona;
    private void tablaUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaUsuariosMouseClicked
        // TODO add your handling code here:
        usuarios = tablaUsuarios.getValueAt(tablaUsuarios.getSelectedRow(), 0) + "";  //cambia el nombre de la tabla
        nombre = tablaUsuarios.getValueAt(tablaUsuarios.getSelectedRow(), 1) + "";

        idPersona= mdb.devuelveUnDato("select idPersona from usuarios where usuario='"+usuarios+"'");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (usuarios.equals("")){
            ...
            if (comboSituacion.getSelectedIndex() == 0) {
                mdb.actualizarBasicos("UPDATE usuarios SET ID_Situacion=2 where usuario='" + usuarios + "'");
            } else if (comboSituacion.getSelectedIndex() == 1) {
                mdb.actualizarBasicos("UPDATE usuarios SET ID_Situacion=1 where usuario='" + usuarios + "'");
            }
            busquedaUsuarios();
            usuarios="";
        }
        ...
        if (estatus.equals("2")) {
            sql = "UPDATE Usuarios SET ID_Situacion=2 where usuario='" + usuarios + "'";

        } else if (estatus.equals("1")) {
            sql = "UPDATE Usuarios SET ID_Situacion=1 where usuario='" + usuarios + "'";
        }
