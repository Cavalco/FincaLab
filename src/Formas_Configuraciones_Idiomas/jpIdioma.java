 ...
 */
public class jpIdioma extends javax.swing.JPanel {
    ...
    public void llenaTabla() {
        limpiar(tabla);
        mdb.cargarInformacion2(modelo, 1, "select Descripcion from Idioma where ID_Situacion=1");
    }
    ...
    public void busqueda() {
      ...
      if (txtBusquedaUE.getText().length() > 0) {
        ...
        if (situacion.equals("Todos")) {
            sql = "SELECT Descripcion from Idioma WHERE ID_Situacion<>3 " + tipoP;
        } else {
            sql = "SELECT Descripcion from Idioma WHERE ID_Situacion=" + situacion + tipoP;
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdP = new jdIdioma(null, true, "1", TxTvar, cn);
        jdP.jp = this;
        jdP.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (TxTvar.equals("")) {
            ...
            jdP = new jdIdioma(null, true, "2", TxTvar, cn);
            jdP.jp = this;
            jdP.setVisible(true);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (TxTvar.equals("")) {
            ...
            String sql = "UPDATE Idioma SET ID_Situacion=2 where descripcion='" + TxTvar + "'";
