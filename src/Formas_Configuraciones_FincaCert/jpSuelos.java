 ...
 */
public class jpSuelos extends javax.swing.JPanel {
    ...
    public jpSuelos(Connection c, String Idioma) {
        ...
        PromptSupport.setPrompt(idioma.getProperty("TipoDeSuelo"), txtBusquedaP);
    ...
    public void llenaTabla() {
        limpiar(tabla);
        mdb.cargarInformacion2(modelo, 1, "select t.descripcion " + "from tiposuelo t " + "WHERE t.ID_Situacion = 1 ");
    }
    ...
    public void busqueda() {
        ...
        if (situacion.equals("3")) {
            sql = "select t.descripcion "
                    + "from tiposuelo t "
                    + "WHERE t.ID_Situacion <> 3 " + tipoP;
        } else {
            sql = "select t.descripcion "
                    + "from tiposuelo t "
                    + "WHERE t.ID_Situacion = " + situacion + tipoP;
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdP = new jdSuelos(null, true, "1", Suelo, Idioma, cn);
        jdP.jp = this;
        jdP.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Suelo.equals("")) {
            ...
            jdP = new jdSuelos(null, true, "2", Suelo, Idioma, cn);
            jdP.jp = this;
            jdP.setVisible(true);
            Suelo="";
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        Suelo = tabla.getValueAt(tabla.getSelectedRow(), 0) + "";  //
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (comboSituacion.getSelectedIndex() == 0) {
            sql = "UPDATE tiposuelo SET ID_Situacion=2 where descripcion='" + Suelo + "'";
        } else if (comboSituacion.getSelectedIndex() == 1) {
            sql = "UPDATE tiposuelo SET ID_Situacion=1 where descripcion='" + Suelo + "'";
        }
