...
public class jpCultivos extends javax.swing.JPanel {
    ...
    public jpCultivos(Connection c, String Idioma) {
        initComponents();
        ...
        //jLabel6.setText(idioma.getProperty("Cultivos"));
        
        PromptSupport.setPrompt(idioma.getProperty("Cultivos"), txtBusquedaCultivos);

        tablaCultivos.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("Cultivos"));
        //tablaCultivos.getColumnModel().getColumn(1).setHeaderValue(idioma.getProperty("Situacion"));
    ...
    String cultivos = "", situacion = "";
    private void tablaCultivosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaCultivosMouseClicked
        // TODO add your handling code here:
        cultivos = modelo.getValueAt(tablaCultivos.getSelectedRow(), 0) + "";

        if (evt.getClickCount() == 2) {
            jdC = new jdCultivos(null, true, "2", cultivos, Idioma, cn);
            jdC.jpC = this;
            jdC.setVisible(true);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        jdC = new jdCultivos(null, true, "1", cultivos, Idioma, cn);
        jdC.jpC = this;
        jdC.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (cultivos.equals("")) {
            ...
            if (comboSituacion.getSelectedIndex() == 0) {
                mdb.actualizarBasicos("UPDATE cultivos SET ID_Situacion=2 where descripcion='" + cultivos + "'");
            } else if (comboSituacion.getSelectedIndex() == 1) {
                mdb.actualizarBasicos("UPDATE cultivos SET ID_Situacion=1 where descripcion='" + cultivos + "'");
            }
            busqueda();
            cultivos = "";
        }
