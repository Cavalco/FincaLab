 ...
 */
public class jpCertificador extends javax.swing.JPanel {
    ...
    public jpCertificador(Connection c, String Idioma) {
        initComponents();
        cn = c;
        this.Idioma = Idioma;
        ...
        //jLabel7.setText(idioma.getProperty("Certificador"));
        
        PromptSupport.setPrompt(idioma.getProperty("Clave"), txtBusquedaP);
        PromptSupport.setPrompt(idioma.getProperty("Certificador"), txtBusquedaK);

        tabla.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("Clave"));
        tabla.getColumnModel().getColumn(1).setHeaderValue(idioma.getProperty("Certificador"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdR = new jdCertificador(null, true, "1", Clave, TxTvar, Idioma, cn);
        jdR.jp = this;
        jdR.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Clave.equals("")) {
            ...
            jdR = new jdCertificador(null, true, "2", Clave, TxTvar, Idioma, cn);
            jdR.jp = this;
            jdR.setVisible(true);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (Clave.equals("")) {
            ...
            if (comboSituacion.getSelectedIndex() == 0) {
                mdb.actualizarBasicos("UPDATE Certificadora SET ID_Situacion=2 where Clave='" + Clave + "'");
            } else if (comboSituacion.getSelectedIndex() == 1) {
                mdb.actualizarBasicos("UPDATE Certificadora SET ID_Situacion=1 where Clave='" + Clave + "'");
            }
        }
        busqueda();
