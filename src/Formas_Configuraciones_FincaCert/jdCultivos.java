 ...
 */
public class jdCultivos extends javax.swing.JDialog {
    ...
    public jdCultivos(java.awt.Frame parent, boolean modal, String tipo, String dato, String Idioma, Connection c) {
        ...
        PlaceHolder holder = new PlaceHolder(txtCultivos, idioma.getProperty("Cultivos"));
    ...
    public void tipoProceso() {
        try {
            String sql = "";
            if (mdb.comprobarExistencia("select descripcion from cultivos where descripcion='" + txtCultivos.getText() + "'") == null) {
                if (tipo.equals("1")) {
                    sql = "INSERT INTO cultivos VALUES(null,'" + txtCultivos.getText() + "', 1, 1,current_date()"
                            + ", current_time(), 1, 1, 1, 1 )";
                    mdb.insertarBasicos(sql);
                    jpC.busqueda();
                    this.dispose();
                } else {
                    sql = "UPDATE cultivos SET  descripcion ='" + txtCultivos.getText() + "' where descripcion='" + dato + "' ";
    ...
    private void initComponents() {
        ...
        txtCultivos = new javax.swing.JTextField();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtCultivos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void txtCultivosKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCultivosKeyReleased
        txtCultivos.setText(txtCultivos.getText().toLowerCase());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdCultivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 /*  java.awt.EventQueue.invokeLater(new Runnable() {
    ...
    private javax.swing.JTextField txtCultivos;
