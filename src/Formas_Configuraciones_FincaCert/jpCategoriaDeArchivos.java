 ...
 */
public class jpCategoriaDeArchivos extends javax.swing.JPanel {

    /**
     * Creates new form jp
     */
    pantallaPrincipal fprin;
    jdCategoriaDeArchivos jdR;
    metodosDatosBasicos mdb;
    DefaultTableModel modelo;
    Connection cn;

    public jpCategoriaDeArchivos(Connection c) {
        initComponents();
        cn = c;
    ...
    public void llenaTabla() {
        limpiar(tabla);
        mdb.cargarInformacion3(modelo, 3, "select Descripcion,Productores,Parcelas from CategoriaDeArchivos where ID_Situacion=1");
    }
    ...
    public void busqueda() {
        ...
        if (txtBusquedaUE.getText().length() > 0) {
            tipoR = "AND UE like '" + txtBusquedaUE.getText() + "%'";
        }
        ...
        if (situacion.equals("Todos")) {
            sql = "SELECT Descripcion,Productores,Parcelas from CategoriaDeArchivos WHERE ID_Situacion<>3 " + tipoP;
        } else {
            sql = "SELECT Descripcion,Productores,Parcelas  from CategoriaDeArchivos WHERE ID_Situacion=" + situacion + tipoP;
        }
        //System.out.println(sql);
        limpiar(tabla);
        mdb.cargarInformacion3(modelo, 3, sql);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Categoria de Archivos");
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Categoria De Archivos", "Obligatorio Para Productores", "Obligatorio Para Parcelas"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdR = new jdCategoriaDeArchivos(null, true, "1", TxTvar, Productor, Parcela, cn);
        jdR.jp = this;
        jdR.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (TxTvar.equals("")) {
            ...
            jdR = new jdCategoriaDeArchivos(null, true, "2", TxTvar, Productor, Parcela, cn);
            jdR.jp = this;
            jdR.setVisible(true);
        }
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        Productor = modelo.getValueAt(tabla.getSelectedRow(), 1) + "";
        Parcela = modelo.getValueAt(tabla.getSelectedRow(), 2) + "";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String sql = "UPDATE CategoriaDeArchivos SET ID_Situacion=2 where Descripcion='" + TxTvar + "'";
