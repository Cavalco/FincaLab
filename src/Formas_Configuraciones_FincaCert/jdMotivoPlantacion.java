 ...
 */
public class jdMotivoPlantacion extends javax.swing.JDialog {
...
validaConfi valiConf;
    ...
    public jdMotivoPlantacion(java.awt.Frame parent, boolean modal, String tipo, String VarTxTC, String Idioma, Connection c) {
        super(parent, modal);
        initComponents();
...
valiConf = new validaConfi();
        ...
        jLabel1.setText(idioma.getProperty("MotivoPlantacion"));
        
        if (tipo.equals("1")) {
            setTitle(idioma.getProperty("NuevoMotivoDePlantacion"));
        }else{
              setTitle(idioma.getProperty("EditarMotivoDePlantacion"));
            
              txtPlantacion.setText(VarTxTC);
        }  
    ...
    public void tipoProceso() {
        try {
         ...
         VarTxT = txtPlantacion.getText();
        

            if (tipo.equals("1")) {
                //nuevoPais();
                sql = "INSERT INTO MotivoPlantacion VALUES(null,'" +VarTxT+ "', 1, 1,current_date()"
                ...
                //editarPais();
                sql = "UPDATE MotivoPlantacion SET  Descripcion ='" +VarTxT+ "' where Descripcion='" + VarTxTC + "' ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Motivo Plantaciòn");
