 ...
 */
public class jdSistemaProduccion extends javax.swing.JDialog {

    /**
     * Creates new form jdVariedadCafe
     */
    jpSistemaProduccion jpSP;
    Connection cn;
    ...
    public jdSistemaProduccion(java.awt.Frame parent, boolean modal, String tipo, String dato, String Idioma, Connection c) {
        super(parent, modal);
        initComponents();
        ...
        jLabel1.setText(idioma.getProperty("SistemaDeProduccion"));;
        
        PlaceHolder holder = new PlaceHolder(txtSistema, idioma.getProperty("SistemaProduccion"));

        if (tipo.equals("1")) {
            //setTitle("NuevoSistemaDeProduccion");
            setTitle(idioma.getProperty("NuevoSistemaDeProduccion"));
        } else {
            //setTitle("EditarSistemaDeProduccion");
            setTitle(idioma.getProperty("EditarSistemaDeProduccion"));
            txtSistema.setText(dato);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdSistemaProduccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
