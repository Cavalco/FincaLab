 ...
 */
public class jpTipoAccion extends javax.swing.JPanel {
    ...
    public jpTipoAccion(Connection c, String Idioma) {
        initComponents();
        cn = c;
        ...
        jLabel6.setText(idioma.getProperty("TipoDeAccion"));
        

        tabla.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("TipoDeAccion"));
    ...
    public void llenaTabla() {
        limpiar(tabla);
        mdb.cargarInformacion2(modelo, 1, "select Descripcion from TipoAccion where ID_Situacion=1");
    }
...
*/
      ...
      if (txtBusquedaUE.getText().length() > 0) {
        ...
        if (situacion.equals("3")) {
            sql = "SELECT Descripcion from TipoAccion WHERE ID_Situacion<>3 " + tipoP;
        } else {
            sql = "SELECT Descripcion from TipoAccion WHERE ID_Situacion=" + situacion + tipoP;
        }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Tipo De Acciòn");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdP = new jdTipoAccion(null, true, "1", TxTvar, Idioma, cn);
        jdP.jp = this;
        jdP.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (TxTvar.equals("")) {
            ...
            jdP = new jdTipoAccion(null, true, "2", TxTvar, Idioma, cn);
            jdP.jp = this;
            jdP.setVisible(true);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (comboSituacion.getSelectedIndex() == 0) {
            mdb.actualizarBasicos("UPDATE TipoAccion SET ID_Situacion=2 where descripcion='" + TxTvar + "'");
        } else if (comboSituacion.getSelectedIndex() == 1) {
            mdb.actualizarBasicos("UPDATE TipoAccion SET ID_Situacion=1 where descripcion='" + TxTvar + "'");
        }
        busqueda();
