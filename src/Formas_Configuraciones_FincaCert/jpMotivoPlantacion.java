 ...
 */
public class jpMotivoPlantacion extends javax.swing.JPanel {

    /**
     * Creates new form jp
     */
    pantallaPrincipal fprin;
    jdMotivoPlantacion jdP;
    ...
    public jpMotivoPlantacion(Connection c, String Idioma) {
        initComponents();
        cn = c;
        ...
        jLabel6.setText(idioma.getProperty("MotivoPlantacion"));

        tabla.getColumnModel().getColumn(0).setHeaderValue(idioma.getProperty("MotivoPlantacion"));
    ...
    public void llenaTabla() {
        limpiar(tabla);
        mdb.cargarInformacion2(modelo, 1, "select Descripcion from MotivoPlantacion where ID_Situacion=1");
    }
...
*/
      ...
      if (txtBusquedaUE.getText().length() > 0) {
        ...
        if (situacion.equals("3")) {
            sql = "SELECT Descripcion from MotivoPlantacion WHERE ID_Situacion<>3 " + tipoP;
        } else {
            sql = "SELECT Descripcion from MotivoPlantacion WHERE ID_Situacion=" + situacion + tipoP;
        }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Motivo Plantaciòn");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jdP = new jdMotivoPlantacion(null, true, "1", TxTvar, Idioma, cn);
        jdP.jp = this;
        jdP.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (TxTvar.equals("")) {
            ...
            jdP = new jdMotivoPlantacion(null, true, "2", TxTvar, Idioma, cn);
            jdP.jp = this;
            jdP.setVisible(true);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (comboSituacion.getSelectedIndex() == 0) {
            mdb.actualizarBasicos("UPDATE motivoPlantacion SET ID_Situacion=2 where descripcion='" + TxTvar + "'");
        } else if (comboSituacion.getSelectedIndex() == 1) {
            mdb.actualizarBasicos("UPDATE motivoPlantacion SET ID_Situacion=1 where descripcion='" + TxTvar + "'");
        }
        busqueda();
