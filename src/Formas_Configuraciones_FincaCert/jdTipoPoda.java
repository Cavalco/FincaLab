 ...
 */
public class jdTipoPoda extends javax.swing.JDialog {
    ...
    public jdTipoPoda(java.awt.Frame parent, boolean modal, String tipo, String VarTxTC, Connection c) {
        super(parent, modal);
        initComponents();
    ...
    public void tipoProceso() {
        try {
            ...
            if (tipo.equals("1")) {
                //nuevoPais();
                sql = "INSERT INTO TipoPoda VALUES(null,'" + VarTxT + "', 1, 1,current_date()"
                ...
                //editarPais();
                sql = "UPDATE TipoPoda SET  Descripcion ='" + VarTxT + "' where Descripcion='" + VarTxTC + "' ";
